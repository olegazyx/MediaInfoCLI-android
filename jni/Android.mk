...
#       zlib\ - From MediaInfo_Allinclusive
# thirdparty\
...
USER_CFLAGS        += -DMEDIAINFO_IBIUSAGE
...
LOCAL_SRC_FILES := \
    ...
    wchar_multibyte.cpp \
    $(MEDIAINFO_DIR)/MediaInfo/Source/CLI/CLI_Main.cpp \
    $(MEDIAINFO_DIR)/MediaInfo/Source/CLI/CommandLine_Parser.cpp \
    $(MEDIAINFO_DIR)/MediaInfo/Source/CLI/Help.cpp \
    $(MEDIAINFO_DIR)/MediaInfo/Source/Common/Core.cpp
...
LOCAL_C_INCLUDES        += $(LOCAL_PATH)/$(MEDIAINFO_DIR)/MediaInfo/Source/Common
LOCAL_C_INCLUDES        += $(LOCAL_PATH)/$(MEDIAINFO_DIR)/MediaInfo/Source/CLI
LOCAL_C_INCLUDES        += $(LOCAL_PATH)/$(MEDIAINFO_DIR)/MediaInfo/Source/PreRelease
LOCAL_C_INCLUDES        += $(LOCAL_PATH)/$(MEDIAINFO_DIR)/MediaInfo/Source/PreRelease/WxWidgets
LOCAL_C_INCLUDES        += $(LOCAL_PATH)/$(MEDIAINFO_DIR)/MediaInfo/Source
